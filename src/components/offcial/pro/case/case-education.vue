<template>
  <div class="caseEducation">
    <div>
      <div class="banner">
        <p>教育培训</p>
        <p>从古至今，教育行业是不可或缺的，所以呢，教育行业的发展也是不可或缺的</p>
      </div>
      <div class="cont">
        <div class="list">
          <ul>
...
.caseEducation .banner{
  width: 100%;
  height: 25rem;
  box-sizing: border-box;
  background-image: url('./../../../../assets/img/case/caseEducation/banner.png');
  background-size: cover;
  text-align: left;
  padding: 9.125rem 0  9.25rem 23rem;
}
.caseEducation .banner p:first-child{
  font-size: 3rem;
  color: #ffffff;
  margin-bottom: 2rem;
}
.caseEducation .banner p:last-child{
  font-size: 1rem;
  color: #ffffff;
}
.caseEducation .cont{
...
.caseEducation .cont .list{
  margin: 0 auto;
  padding-left: 20%;
}
.caseEducation .cont .list ul li{
  float: left;
  width: 17.0625rem;
  height: 17.9375rem;
  box-sizing:unset;
...
.caseEducation .cont .list ul li:last-child{
  margin-right: 0;
}
.caseEducation .cont .listItem{
  position: relative;
}
.caseEducation .cont .list .listBg{
  margin: 0 auto;
  width: 17.5rem;
  height: 18.3rem;
}
.caseEducation .cont .list .listDetail{
  width: 16.76rem;
  height: 9.125rem;
  margin: 0 auto;
...
.caseEducation .cont .list .listItem:hover .listDetail{
  display: block;
}
.caseEducation .cont .list .listDContText{
  font-size: 1rem;
  color: #333333;
  box-sizing: border-box;
