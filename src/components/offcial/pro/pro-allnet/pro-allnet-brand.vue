<template>
  <div class="proAllnetBrand">
    <div>
      <div class="banner">
        <p>品牌响应式门户</p>
        <p>打造专属您的品牌，创造不一样的视觉体验，带给您无限的方便</p>
      </div>
      <div class="onePart">
        <p class="title">响应式品牌门户</p>
        <div class="onePartCont">
          <div class="onePartContL">
            <p>关注网站本身设计的同时更要通过网站改善品牌运营以及网站所提供的业务机遇。</p>
            <p>九江东注与您协作，为您持续提供网络整个营销及增值服务，让您的品牌网站更有意义。</p>
          </div>
          <div class="onePartContR">
            <img src="../../../../assets/img/pro-allnet/brand/detail-banner1-top.png" alt="">
          </div>
        </div>
      </div>
      <div class="twoPart">
            ...
            <el-tab-pane label="产品优势" name="first">
              <div class="one clearfix">
                <div class="oneTop clearfix">
                  <div class="banner1left"><img src="../../../../assets/img/pro-allnet/brand/detail-banner1-top.png" alt=""></div>
                  <div class="banner1right"><img src="../../../../assets/img/pro-allnet/brand/detail-banner1-bottom.png" alt=""></div>
...
.proAllnetBrand .banner{
  width: 100%;
  height: 25rem;
  box-sizing: border-box;
  background-image: url(../../../../assets/img/pro-allnet/brand/pro-allnet-banner.png);
  background-size: cover;
  text-align: left;
  padding: 9.125rem 0  9.25rem 23rem;
}
.proAllnetBrand .banner p:first-child{
  font-size: 3rem;
  color: #ffffff;
  margin-bottom: 2rem;
}
.proAllnetBrand .banner p:last-child{
  font-size: 1rem;
  color: #ffffff;
}
/* 第一部分 */
.proAllnetBrand .onePart{
  margin-top:6.25rem;
}
.onePart .onePartCont{
  margin: 0 auto;
...
.onePart .onePartCont .onePartContL{
  width: 39.3125rem;
  height: 6.125rem;
  font-size: 1.25rem;
  color: #666;
...
.onePart .onePartCont .onePartContL p{
  text-indent: 2rem;
}
.onePart .onePartCont .onePartContR{
  vertical-align: middle;
}
/* 第二部分 */
/* 产品优势  第一部分*/
...
<style>
.proAllnetBrand .el-tabs__header{
  height: 4rem;
  width: 100%;
...
.proAllnetBrand .el-tabs__nav-wrap{
  height: 4rem;
  width: 100%;
  text-align: center;
  margin: 0 auto;
...
.proAllnetBrand .el-tabs--card>.el-tabs__header .el-tabs__item{
  width: 19rem;
  height: 4rem;
  line-height: 4rem;
  font-size: 1rem;
...
.proAllnetBrand .el-tabs--card>.el-tabs__header .el-tabs__item.is-active{
  color: #02004b;
  background-color: #ffffff;
  opacity: 0.55;
}
