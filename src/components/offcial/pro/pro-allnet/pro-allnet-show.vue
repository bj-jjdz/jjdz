<template>
  <div class="proAllnetShow">
    <div>
      <div class="banner">
        <p>响应式展示门户</p>
        <p>企业门户的基础配置，多端适配，完美展示企业信息</p>
      </div>
      <div class="tab">
        <template>
            ...
            <el-tab-pane label="产品优势" name="first">
              <div class="one clearfix">
                <div class="oneTop clearfix">
                  <div class="banner1left"><img src="../../../../assets/img/pro-allnet/show/detail-banner1-left.png" alt=""></div>
                  <div class="banner1right"><img src="../../../../assets/img/pro-allnet/show/detail-banner1-right.png" alt=""></div>
                  <div class="banner1Text">
                    <p>一套页面设计，多端展现</p>
                    <p>PC端网站+移动端网站+Pad+TV</p>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    informaLeftBtn () {
      ...
      if (mobile === '' || text === '' || company === '' || mobile.length !== 11) {
...
.proAllnetShow .banner p:first-child{
  font-size: 3rem;
  color: #ffffff;
  margin-bottom: 2rem;
}
.proAllnetShow .banner p:last-child{
  font-size: 1rem;
  color: #ffffff;
}
/* 产品优势  第一部分*/
...
.proAllnetShow .el-tabs__nav-wrap{
  height: 4rem;
  width: 100%;
  text-align: center;
  margin: 0 auto;
...
.proAllnetShow .el-tabs--card>.el-tabs__header .el-tabs__item{
  width: 19rem;
  height: 4rem;
  line-height: 4rem;
  font-size: 1rem;
...
.proAllnetShow .el-tabs--card>.el-tabs__header .el-tabs__item.is-active{
  color: #02004b;
  background-color: #ffffff;
  opacity: 0.55;
}
